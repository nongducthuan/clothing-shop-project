...
export function EmptyCheckout({ onShop }) {
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center bg-white dark:bg-slate-900 text-center px-6">
      ...
      <h2 className="text-3xl font-medium text-slate-900 dark:text-slate-100 tracking-tight">Your cart is empty.</h2>
      <p className="text-slate-500 dark:text-slate-400 mt-3 mb-10 text-lg">Add some items before proceeding to checkout.</p>
      <button
        onClick={onShop}
