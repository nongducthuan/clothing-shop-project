    ...
    <div className="flex flex-col sm:flex-row gap-4 mb-8">
      <form onSubmit={handleSearchSubmit} className="flex-1 relative">
        <div className="relative w-full max-w-2xl">
          ...
          <button
            type="submit"
            className="absolute right-2 top-1/2 -translate-y-1/2 w-10 h-10 flex items-center justify-center text-white bg-violet-600 rounded-xl hover:bg-violet-700 transition-all shadow-md active:scale-95"
          >
