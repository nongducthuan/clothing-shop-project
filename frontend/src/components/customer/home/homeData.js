export const BACKEND_URL = import.meta.env.VITE_IMAGE_URL;
...
export const GENDER_PROMOS = [
  {
    ...
    title: "MEN WEAR",
    desc: "Use code COOLNEW: 50K off first order over 299k",
  },
  {
    img: "/assets/images/women-active.png",
    title: "WOMEN ACTIVE",
    desc: "Use code CMVSEAMLESS: 50K off Seamless Collection",
  },
];
...
export const POLICIES = [
  { icon: "🎁", title: "Discounts", desc: "10% off for new customers" },
  { icon: "🚚", title: "Free Shipping", desc: "Free shipping on orders over 500k" },
  { icon: "🔄", title: "Returns", desc: "Free returns within 7 days" },
];
