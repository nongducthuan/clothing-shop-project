  ...
  return (
    <>
      ...
      <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 h-full flex flex-col overflow-hidden">
        <div className="bg-gradient-to-r from-blue-500 to-indigo-600 p-5 shrink-0 flex justify-between items-center">
        ...
        <form onSubmit={onSubmit} className="p-6 space-y-4 flex-grow flex flex-col">
          ...
          <button type="submit" className="w-full py-3 bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white rounded-xl font-bold text-xs tracking-wider hover:scale-[1.01] transition-all shadow-md shadow-indigo-200 uppercase mt-4">
            ACTIVATE SALE
          </button>
        </form>
      </div>
