      ...
      <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-sm border border-slate-200/80 dark:border-slate-700 h-full flex flex-col overflow-hidden">
        ...
        <form onSubmit={onSubmit} className="p-6 space-y-4 flex-grow flex flex-col">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div
              className="relative p-3 bg-slate-50 dark:bg-slate-700/60 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-2xl cursor-pointer transition-colors border border-slate-200/80 dark:border-slate-600 focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-500"
