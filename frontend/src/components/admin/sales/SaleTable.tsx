              ...
              <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                ...
                <td className="py-4 px-4">
                  <button
                    ...
                    className="text-rose-500 bg-transparent hover:text-rose-700 hover:bg-rose-50 px-3 py-1.5 rounded-xl transition-all text-sm font-bold border border-transparent hover:border-rose-100"
                  >
                    Delete
                  </button>
                </td>
