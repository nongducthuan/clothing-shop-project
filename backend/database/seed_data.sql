...
(101, 'Ngày 01', 'ngay01@test.com', '0900000001', 'Hà Nội', 0, 'Return Requested', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 30 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 30 DAY),
(102, 'Ngày 02', 'ngay02@test.com', '0900000002', 'TP HCM', 0, 'Return Requested', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 29 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 29 DAY),
(103, 'Ngày 03', 'ngay03@test.com', '0900000003', 'Đà Nẵng', 0, 'Return Requested', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 28 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 28 DAY),
(104, 'Ngày 04', 'ngay04@test.com', '0900000004', 'Cần Thơ', 0, 'Return Requested', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 27 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 27 DAY),
(105, 'Ngày 05', 'ngay05@test.com', '0900000005', 'Hải Phòng', 0, 'Return Approved', 'Refunded', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 26 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 26 DAY),
(106, 'Ngày 06', 'ngay06@test.com', '0900000006', 'Nha Trang', 0, 'Return Approved', 'Refunded', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 25 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 25 DAY),
(107, 'Ngày 07', 'ngay07@test.com', '0900000007', 'Huế', 0, 'Return Approved', 'Refunded', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 24 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 24 DAY),
(108, 'Ngày 08', 'ngay08@test.com', '0900000008', 'Hà Nội', 0, 'Return Approved', 'Refunded', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 23 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 23 DAY),
...
(116, 'Ngày 16', 'ngay16@test.com', '0900000016', 'TP HCM', 0, 'Confirmed', 'Unpaid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 15 DAY, NULL),
(117, 'Ngày 17', 'ngay17@test.com', '0900000017', 'Đà Nẵng', 0, 'Shipping', 'Unpaid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 14 DAY, NULL),
(118, 'Ngày 18', 'ngay18@test.com', '0900000018', 'Cần Thơ', 0, 'Shipping', 'Unpaid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 13 DAY, NULL),
(119, 'Ngày 19', 'ngay19@test.com', '0900000019', 'Hải Phòng', 0, 'Cancelled', 'Unpaid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 12 DAY, NULL),
(120, 'Ngày 20', 'ngay20@test.com', '0900000020', 'Nha Trang', 0, 'Cancelled', 'Unpaid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 11 DAY, NULL),
...
(201, 'Tháng 01', 'thang01@test.com', '0900000031', 'Hà Nội', 0, 'Delivered', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 13 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 13 MONTH), '%Y-%m-15 12:00:00')),
(202, 'Tháng 02', 'thang02@test.com', '0900000032', 'TP HCM', 0, 'Delivered', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 12 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 12 MONTH), '%Y-%m-15 12:00:00')),
(203, 'Tháng 03', 'thang03@test.com', '0900000033', 'Đà Nẵng', 0, 'Delivered', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 11 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 11 MONTH), '%Y-%m-15 12:00:00')),
(204, 'Tháng 04', 'thang04@test.com', '0900000034', 'Cần Thơ', 0, 'Delivered', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 10 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 10 MONTH), '%Y-%m-15 12:00:00')),
(205, 'Tháng 05', 'thang05@test.com', '0900000035', 'Hải Phòng', 0, 'Delivered', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 9 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 9 MONTH), '%Y-%m-15 12:00:00')),
(206, 'Tháng 06', 'thang06@test.com', '0900000036', 'Nha Trang', 0, 'Delivered', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 8 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 8 MONTH), '%Y-%m-15 12:00:00')),
(207, 'Tháng 07', 'thang07@test.com', '0900000037', 'Huế', 0, 'Delivered', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 7 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 7 MONTH), '%Y-%m-15 12:00:00')),
(208, 'Tháng 08', 'thang08@test.com', '0900000038', 'Hà Nội', 0, 'Delivered', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 6 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 6 MONTH), '%Y-%m-15 12:00:00')),
(209, 'Tháng 09', 'thang09@test.com', '0900000039', 'TP HCM', 0, 'Delivered', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 5 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 5 MONTH), '%Y-%m-15 12:00:00')),
(210, 'Tháng 10', 'thang10@test.com', '0900000040', 'Đà Nẵng', 0, 'Delivered', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 4 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 4 MONTH), '%Y-%m-15 12:00:00')),
(211, 'Tháng 11', 'thang11@test.com', '0900000049', 'Cần Thơ', 0, 'Delivered', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 3 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 3 MONTH), '%Y-%m-15 12:00:00')),
(212, 'Tháng 12', 'thang12@test.com', '0900000050', 'Hải Phòng', 0, 'Delivered', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 2 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 2 MONTH), '%Y-%m-15 12:00:00'));
...
(101, 'Damaged', 'Pending'),
(102, 'Wrong item', 'Pending'),
(103, 'Change mind', 'Pending'),
(104, 'Not as described', 'Pending'),
