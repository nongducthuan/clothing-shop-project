...
(101, 'Ngày 01', 'ngay01@test.com', '0900000001', 'Hà Nội', 0, 'Pending', 'Unpaid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 30 DAY, NULL),
(102, 'Ngày 02', 'ngay02@test.com', '0900000002', 'TP HCM', 0, 'Pending', 'Unpaid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 29 DAY, NULL),
(103, 'Ngày 03', 'ngay03@test.com', '0900000003', 'Đà Nẵng', 0, 'Pending', 'Unpaid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 28 DAY, NULL),
(104, 'Ngày 04', 'ngay04@test.com', '0900000004', 'Cần Thơ', 0, 'Pending', 'Unpaid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 27 DAY, NULL),
(105, 'Ngày 05', 'ngay05@test.com', '0900000005', 'Hải Phòng', 0, 'Confirmed', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 26 DAY, NULL),
(106, 'Ngày 06', 'ngay06@test.com', '0900000006', 'Nha Trang', 0, 'Confirmed', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 25 DAY, NULL),
(107, 'Ngày 07', 'ngay07@test.com', '0900000007', 'Huế', 0, 'Confirmed', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 24 DAY, NULL),
(108, 'Ngày 08', 'ngay08@test.com', '0900000008', 'Hà Nội', 0, 'Confirmed', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 23 DAY, NULL),
(109, 'Ngày 09', 'ngay09@test.com', '0900000009', 'TP HCM', 0, 'Shipping', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 22 DAY, NULL),
(110, 'Ngày 10', 'ngay10@test.com', '0900000010', 'Đà Nẵng', 0, 'Shipping', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 21 DAY, NULL),
(111, 'Ngày 11', 'ngay11@test.com', '0900000011', 'Cần Thơ', 0, 'Shipping', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 20 DAY, NULL),
(112, 'Ngày 12', 'ngay12@test.com', '0900000012', 'Hải Phòng', 0, 'Shipping', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 19 DAY, NULL),
(113, 'Ngày 13', 'ngay13@test.com', '0900000013', 'Nha Trang', 0, 'Cancelled', 'Unpaid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 18 DAY, NULL),
(114, 'Ngày 14', 'ngay14@test.com', '0900000014', 'Huế', 0, 'Cancelled', 'Unpaid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 17 DAY, NULL),
(115, 'Ngày 15', 'ngay15@test.com', '0900000015', 'Hà Nội', 0, 'Cancelled', 'Unpaid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 16 DAY, NULL),
(116, 'Ngày 16', 'ngay16@test.com', '0900000016', 'TP HCM', 0, 'Cancelled', 'Unpaid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 15 DAY, NULL),
(117, 'Ngày 17', 'ngay17@test.com', '0900000017', 'Đà Nẵng', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 14 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 14 DAY),
(118, 'Ngày 18', 'ngay18@test.com', '0900000018', 'Cần Thơ', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 13 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 13 DAY),
(119, 'Ngày 19', 'ngay19@test.com', '0900000019', 'Hải Phòng', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 12 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 12 DAY),
(120, 'Ngày 20', 'ngay20@test.com', '0900000020', 'Nha Trang', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 11 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 11 DAY),
(121, 'Ngày 21', 'ngay21@test.com', '0900000021', 'Huế', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 10 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 10 DAY),
(122, 'Ngày 22', 'ngay22@test.com', '0900000022', 'Hà Nội', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 9 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 9 DAY),
(123, 'Ngày 23', 'ngay23@test.com', '0900000023', 'TP HCM', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 8 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 8 DAY),
(124, 'Ngày 24', 'ngay24@test.com', '0900000024', 'Đà Nẵng', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 7 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 7 DAY),
(125, 'Ngày 25', 'ngay25@test.com', '0900000025', 'Cần Thơ', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 6 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 6 DAY),
(126, 'Ngày 26', 'ngay26@test.com', '0900000026', 'Hải Phòng', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 5 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 5 DAY),
(127, 'Ngày 27', 'ngay27@test.com', '0900000027', 'Nha Trang', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 4 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 4 DAY),
(128, 'Ngày 28', 'ngay28@test.com', '0900000028', 'Huế', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 3 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 3 DAY),
(129, 'Ngày 29', 'ngay29@test.com', '0900000029', 'Hà Nội', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 2 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 2 DAY),
(130, 'Ngày 30', 'ngay30@test.com', '0900000030', 'TP HCM', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 1 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 1 DAY),
(201, 'Tháng 01', 'thang01@test.com', '0900000031', 'Hà Nội', 0, 'Return Requested', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 12 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 12 MONTH), '%Y-%m-15 12:00:00')),
(202, 'Tháng 02', 'thang02@test.com', '0900000032', 'TP HCM', 0, 'Return Approved', 'Refunded', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 11 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 11 MONTH), '%Y-%m-15 12:00:00')),
(203, 'Tháng 03', 'thang03@test.com', '0900000033', 'Đà Nẵng', 0, 'Return Rejected', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 10 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 10 MONTH), '%Y-%m-15 12:00:00')),
(204, 'Tháng 04', 'thang04@test.com', '0900000034', 'Cần Thơ', 0, 'Return Requested', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 9 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 9 MONTH), '%Y-%m-15 12:00:00')),
(205, 'Tháng 05', 'thang05@test.com', '0900000035', 'Hải Phòng', 0, 'Return Approved', 'Refunded', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 8 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 8 MONTH), '%Y-%m-15 12:00:00')),
(206, 'Tháng 06', 'thang06@test.com', '0900000036', 'Nha Trang', 0, 'Return Rejected', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 7 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 7 MONTH), '%Y-%m-15 12:00:00')),
(207, 'Tháng 07', 'thang07@test.com', '0900000037', 'Huế', 0, 'Return Requested', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 6 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 6 MONTH), '%Y-%m-15 12:00:00')),
(208, 'Tháng 08', 'thang08@test.com', '0900000038', 'Hà Nội', 0, 'Return Approved', 'Refunded', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 5 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 5 MONTH), '%Y-%m-15 12:00:00')),
(209, 'Tháng 09', 'thang09@test.com', '0900000039', 'TP HCM', 0, 'Return Rejected', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 4 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 4 MONTH), '%Y-%m-15 12:00:00')),
(210, 'Tháng 10', 'thang10@test.com', '0900000040', 'Đà Nẵng', 0, 'Return Requested', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 3 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 3 MONTH), '%Y-%m-15 12:00:00')),
(211, 'Tháng 11', 'thang11@test.com', '0900000049', 'Cần Thơ', 0, 'Return Approved', 'Refunded', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 2 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 2 MONTH), '%Y-%m-15 12:00:00')),
(212, 'Tháng 12', 'thang12@test.com', '0900000050', 'Hải Phòng', 0, 'Return Rejected', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 1 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 1 MONTH), '%Y-%m-15 12:00:00'));
...
(201, 'Damaged', 'Pending'),
(202, 'Wrong item', 'Approved'),
(203, 'Change mind', 'Rejected'),
(204, 'Not as described', 'Pending'),
(205, 'Damaged', 'Approved'),
(206, 'Wrong item', 'Rejected'),
(207, 'Change mind', 'Pending'),
(208, 'Not as described', 'Approved'),
(209, 'Damaged', 'Rejected'),
(210, 'Wrong item', 'Pending'),
(211, 'Change mind', 'Approved'),
(212, 'Not as described', 'Rejected');
