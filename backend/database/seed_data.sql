...
(201, 'Nguyễn Văn A', 'a@test.com', '0901', 'Hà Nội', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 7 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 7 DAY),
(202, 'Trần Thị B', 'b@test.com', '0902', 'TP HCM', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 6 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 6 DAY),
(203, 'Lê Văn C', 'c@test.com', '0903', 'Đà Nẵng', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 5 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 5 DAY),
(204, 'Phạm Thị D', 'd@test.com', '0904', 'Cần Thơ', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 4 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 4 DAY),
(205, 'Hoàng Văn E', 'e@test.com', '0905', 'Hải Phòng', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 3 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 3 DAY),
(206, 'Vũ Thị F', 'f@test.com', '0906', 'Nha Trang', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 2 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 2 DAY),
(207, 'Đặng Văn G', 'g@test.com', '0907', 'Huế', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 1 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 1 DAY),
(208, 'Khách H', 'h@test.com', '0908', 'Hà Nội', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 8 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 8 DAY),
(209, 'Khách I', 'i@test.com', '0909', 'TP HCM', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 10 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 10 DAY),
(210, 'Khách J', 'j@test.com', '0910', 'Đà Nẵng', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 13 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 13 DAY),
(211, 'Khách K', 'k@test.com', '0911', 'Cần Thơ', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 15 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 15 DAY),
(212, 'Khách L', 'l@test.com', '0912', 'Hải Phòng', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 17 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 17 DAY),
(213, 'Khách M', 'm@test.com', '0913', 'Nha Trang', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 20 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 20 DAY),
(214, 'Khách N', 'n@test.com', '0914', 'Huế', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 22 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 22 DAY),
(215, 'Khách O', 'o@test.com', '0915', 'Hà Nội', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 24 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 24 DAY),
(216, 'Khách P', 'p@test.com', '0916', 'TP HCM', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 25 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 25 DAY),
(217, 'Khách Q', 'q@test.com', '0917', 'Đà Nẵng', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 27 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 27 DAY),
(218, 'Khách R', 'r@test.com', '0918', 'Cần Thơ', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 28 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 28 DAY),
(219, 'Khách S', 's@test.com', '0919', 'Hải Phòng', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 29 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 29 DAY),
...
(312, 'Tháng 12', 't12@t.com', '090', 'L', 0, 'Return Rejected', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 1 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 1 MONTH), '%Y-%m-15 12:00:00'));
