...
(201, 'Ngày 01', 'ngay01@test.com', '0901', 'Hà Nội', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 1 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 1 DAY),
(202, 'Ngày 02', 'ngay02@test.com', '0902', 'TP HCM', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 2 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 2 DAY),
(203, 'Ngày 03', 'ngay03@test.com', '0903', 'Đà Nẵng', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 3 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 3 DAY),
(204, 'Ngày 04', 'ngay04@test.com', '0904', 'Cần Thơ', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 4 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 4 DAY),
(205, 'Ngày 05', 'ngay05@test.com', '0905', 'Hải Phòng', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 5 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 5 DAY),
(206, 'Ngày 06', 'ngay06@test.com', '0906', 'Nha Trang', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 6 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 6 DAY),
(207, 'Ngày 07', 'ngay07@test.com', '0907', 'Huế', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 7 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 7 DAY),
(208, 'Ngày 08', 'ngay08@test.com', '0908', 'Hà Nội', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 8 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 8 DAY),
(209, 'Ngày 10', 'ngay10@test.com', '0909', 'TP HCM', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 10 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 10 DAY),
(210, 'Ngày 13', 'ngay13@test.com', '0910', 'Đà Nẵng', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 13 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 13 DAY),
(211, 'Ngày 15', 'ngay15@test.com', '0911', 'Cần Thơ', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 15 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 15 DAY),
(212, 'Ngày 17', 'ngay17@test.com', '0912', 'Hải Phòng', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 17 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 17 DAY),
(213, 'Ngày 20', 'ngay20@test.com', '0913', 'Nha Trang', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 20 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 20 DAY),
(214, 'Ngày 22', 'ngay22@test.com', '0914', 'Huế', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 22 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 22 DAY),
(215, 'Ngày 24', 'ngay24@test.com', '0915', 'Hà Nội', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 24 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 24 DAY),
(216, 'Ngày 25', 'ngay25@test.com', '0916', 'TP HCM', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 25 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 25 DAY),
(217, 'Ngày 27', 'ngay27@test.com', '0917', 'Đà Nẵng', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 27 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 27 DAY),
(218, 'Ngày 28', 'ngay28@test.com', '0918', 'Cần Thơ', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 28 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 28 DAY),
(219, 'Ngày 29', 'ngay29@test.com', '0919', 'Hải Phòng', 0, 'Delivered', 'Paid', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 29 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 29 DAY),
(301, 'Tháng 1', 't1@t.com', '090', 'A', 0, 'Return Requested', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 12 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 12 MONTH), '%Y-%m-15 12:00:00')),
(302, 'Tháng 2', 't2@t.com', '090', 'B', 0, 'Return Requested', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 11 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 11 MONTH), '%Y-%m-15 12:00:00')),
(303, 'Tháng 3', 't3@t.com', '090', 'C', 0, 'Return Requested', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 10 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 10 MONTH), '%Y-%m-15 12:00:00')),
(304, 'Tháng 4', 't4@t.com', '090', 'D', 0, 'Return Requested', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 9 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 9 MONTH), '%Y-%m-15 12:00:00')),
(305, 'Tháng 5', 't5@t.com', '090', 'E', 0, 'Return Approved', 'Refunded', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 8 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 8 MONTH), '%Y-%m-15 12:00:00')),
(306, 'Tháng 6', 't6@t.com', '090', 'F', 0, 'Return Approved', 'Refunded', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 7 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 7 MONTH), '%Y-%m-15 12:00:00')),
(307, 'Tháng 7', 't7@t.com', '090', 'G', 0, 'Return Approved', 'Refunded', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 6 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 6 MONTH), '%Y-%m-15 12:00:00')),
(308, 'Tháng 8', 't8@t.com', '090', 'H', 0, 'Return Approved', 'Refunded', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 5 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 5 MONTH), '%Y-%m-15 12:00:00')),
(309, 'Tháng 9', 't9@t.com', '090', 'I', 0, 'Return Rejected', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 4 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 4 MONTH), '%Y-%m-15 12:00:00')),
(310, 'Tháng 10', 't10@t.com', '090', 'J', 0, 'Return Rejected', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 3 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 3 MONTH), '%Y-%m-15 12:00:00')),
(311, 'Tháng 11', 't11@t.com', '090', 'K', 0, 'Return Rejected', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 2 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 2 MONTH), '%Y-%m-15 12:00:00')),
(312, 'Tháng 12', 't12@t.com', '090', 'L', 0, 'Return Rejected', 'Paid', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 1 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 1 MONTH), '%Y-%m-15 12:00:00')); '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 1 MONTH),  '%Y-%m-15 12:00:00'));
