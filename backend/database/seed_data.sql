...
(301, 'Tháng 1', 't1@t.com', '090', 'A', 0, 'Return Requested', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 11 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 11 MONTH), '%Y-%m-15 12:00:00')),
(302, 'Tháng 2', 't2@t.com', '090', 'B', 0, 'Return Requested', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 10 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 10 MONTH), '%Y-%m-15 12:00:00')),
(303, 'Tháng 3', 't3@t.com', '090', 'C', 0, 'Return Requested', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 9 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 9 MONTH), '%Y-%m-15 12:00:00')),
(304, 'Tháng 4', 't4@t.com', '090', 'D', 0, 'Return Requested', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 8 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 8 MONTH), '%Y-%m-15 12:00:00')),
(305, 'Tháng 5', 't5@t.com', '090', 'E', 0, 'Return Approved', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 7 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 7 MONTH), '%Y-%m-15 12:00:00')),
(306, 'Tháng 6', 't6@t.com', '090', 'F', 0, 'Return Approved', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 6 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 6 MONTH), '%Y-%m-15 12:00:00')),
(307, 'Tháng 7', 't7@t.com', '090', 'G', 0, 'Return Approved', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 5 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 5 MONTH), '%Y-%m-15 12:00:00')),
(308, 'Tháng 8', 't8@t.com', '090', 'H', 0, 'Return Approved', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 4 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 4 MONTH), '%Y-%m-15 12:00:00')),
