...
(201, 'Nguyễn Văn A', 'a@test.com', '0901', 'Hà Nội', 0, 'Delivered', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 7 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 7 DAY),
...
(205, 'Hoàng Văn E', 'e@test.com', '0905', 'Hải Phòng', 0, 'Delivered', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 3 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 3 DAY),
(206, 'Vũ Thị F', 'f@test.com', '0906', 'Nha Trang', 0, 'Delivered', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 2 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 2 DAY),
(207, 'Đặng Văn G', 'g@test.com', '0907', 'Huế', 0, 'Delivered', DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 1 DAY, DATE_ADD(CURDATE(), INTERVAL 12 HOUR) - INTERVAL 1 DAY),
(301, 'Tháng 1', 't1@t.com', '090', 'A', 0, 'Return Requested', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 12 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 12 MONTH), '%Y-%m-15 12:00:00')),
(302, 'Tháng 2', 't2@t.com', '090', 'B', 0, 'Return Requested', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 11 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 11 MONTH), '%Y-%m-15 12:00:00')),
(303, 'Tháng 3', 't3@t.com', '090', 'C', 0, 'Return Requested', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 10 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 10 MONTH), '%Y-%m-15 12:00:00')),
(304, 'Tháng 4', 't4@t.com', '090', 'D', 0, 'Return Requested', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 9 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 9 MONTH), '%Y-%m-15 12:00:00')),
(305, 'Tháng 5', 't5@t.com', '090', 'E', 0, 'Return Approved', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 8 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 8 MONTH), '%Y-%m-15 12:00:00')),
(306, 'Tháng 6', 't6@t.com', '090', 'F', 0, 'Return Approved', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 7 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 7 MONTH), '%Y-%m-15 12:00:00')),
(307, 'Tháng 7', 't7@t.com', '090', 'G', 0, 'Return Approved', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 6 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 6 MONTH), '%Y-%m-15 12:00:00')),
(308, 'Tháng 8', 't8@t.com', '090', 'H', 0, 'Return Approved', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 5 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 5 MONTH), '%Y-%m-15 12:00:00')),
(309, 'Tháng 9', 't9@t.com', '090', 'I', 0, 'Return Rejected', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 4 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 4 MONTH), '%Y-%m-15 12:00:00')),
(310, 'Tháng 10', 't10@t.com', '090', 'J', 0, 'Return Rejected', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 3 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 3 MONTH), '%Y-%m-15 12:00:00')),
(311, 'Tháng 11', 't11@t.com', '090', 'K', 0, 'Return Rejected', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 2 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 2 MONTH), '%Y-%m-15 12:00:00')),
(312, 'Tháng 12', 't12@t.com', '090', 'L', 0, 'Return Rejected', DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 1 MONTH), '%Y-%m-15 12:00:00'), DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 1 MONTH), '%Y-%m-15 12:00:00'));
