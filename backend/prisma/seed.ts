...
async function main() {
  ...
  // ============================================================
  const DELIVERED_AT_STATUSES: OrderStatus[] = [
  ...
  const ordersData = [
    { id: 101, name: 'Ngày 01', email: 'ngay01@test.com', phone: '0900000001', address: 'Hà Nội', created_at: daysAgo(30), status: OrderStatus.Return_Requested, payment_status: 'Paid' as any },
    { id: 102, name: 'Ngày 02', email: 'ngay02@test.com', phone: '0900000002', address: 'TP HCM', created_at: daysAgo(29), status: OrderStatus.Return_Requested, payment_status: 'Paid' as any },
    { id: 103, name: 'Ngày 03', email: 'ngay03@test.com', phone: '0900000003', address: 'Đà Nẵng', created_at: daysAgo(28), status: OrderStatus.Return_Requested, payment_status: 'Paid' as any },
    { id: 104, name: 'Ngày 04', email: 'ngay04@test.com', phone: '0900000004', address: 'Cần Thơ', created_at: daysAgo(27), status: OrderStatus.Return_Requested, payment_status: 'Paid' as any },
    { id: 105, name: 'Ngày 05', email: 'ngay05@test.com', phone: '0900000005', address: 'Hải Phòng', created_at: daysAgo(26), status: OrderStatus.Return_Approved, payment_status: 'Refunded' as any },
    { id: 106, name: 'Ngày 06', email: 'ngay06@test.com', phone: '0900000006', address: 'Nha Trang', created_at: daysAgo(25), status: OrderStatus.Return_Approved, payment_status: 'Refunded' as any },
    { id: 107, name: 'Ngày 07', email: 'ngay07@test.com', phone: '0900000007', address: 'Huế', created_at: daysAgo(24), status: OrderStatus.Return_Approved, payment_status: 'Refunded' as any },
    { id: 108, name: 'Ngày 08', email: 'ngay08@test.com', phone: '0900000008', address: 'Hà Nội', created_at: daysAgo(23), status: OrderStatus.Return_Approved, payment_status: 'Refunded' as any },
    { id: 109, name: 'Ngày 09', email: 'ngay09@test.com', phone: '0900000009', address: 'TP HCM', created_at: daysAgo(22), status: OrderStatus.Return_Rejected, payment_status: 'Paid' as any },
    { id: 110, name: 'Ngày 10', email: 'ngay10@test.com', phone: '0900000010', address: 'Đà Nẵng', created_at: daysAgo(21), status: OrderStatus.Return_Rejected, payment_status: 'Paid' as any },
    { id: 111, name: 'Ngày 11', email: 'ngay11@test.com', phone: '0900000011', address: 'Cần Thơ', created_at: daysAgo(20), status: OrderStatus.Return_Rejected, payment_status: 'Paid' as any },
    { id: 112, name: 'Ngày 12', email: 'ngay12@test.com', phone: '0900000012', address: 'Hải Phòng', created_at: daysAgo(19), status: OrderStatus.Return_Requested, payment_status: 'Paid' as any },
    { id: 113, name: 'Ngày 13', email: 'ngay13@test.com', phone: '0900000013', address: 'Nha Trang', created_at: daysAgo(18), status: OrderStatus.Pending, payment_status: 'Unpaid' as any },
    { id: 114, name: 'Ngày 14', email: 'ngay14@test.com', phone: '0900000014', address: 'Huế', created_at: daysAgo(17), status: OrderStatus.Pending, payment_status: 'Unpaid' as any },
    { id: 115, name: 'Ngày 15', email: 'ngay15@test.com', phone: '0900000015', address: 'Hà Nội', created_at: daysAgo(16), status: OrderStatus.Confirmed, payment_status: 'Unpaid' as any },
    { id: 116, name: 'Ngày 16', email: 'ngay16@test.com', phone: '0900000016', address: 'TP HCM', created_at: daysAgo(15), status: OrderStatus.Confirmed, payment_status: 'Unpaid' as any },
    { id: 117, name: 'Ngày 17', email: 'ngay17@test.com', phone: '0900000017', address: 'Đà Nẵng', created_at: daysAgo(14), status: OrderStatus.Shipping, payment_status: 'Unpaid' as any },
    { id: 118, name: 'Ngày 18', email: 'ngay18@test.com', phone: '0900000018', address: 'Cần Thơ', created_at: daysAgo(13), status: OrderStatus.Shipping, payment_status: 'Unpaid' as any },
    { id: 119, name: 'Ngày 19', email: 'ngay19@test.com', phone: '0900000019', address: 'Hải Phòng', created_at: daysAgo(12), status: OrderStatus.Cancelled, payment_status: 'Unpaid' as any },
    { id: 120, name: 'Ngày 20', email: 'ngay20@test.com', phone: '0900000020', address: 'Nha Trang', created_at: daysAgo(11), status: OrderStatus.Cancelled, payment_status: 'Unpaid' as any },
    ...
    { id: 201, name: 'Tháng 01', email: 'thang01@test.com', phone: '0900000031', address: 'Hà Nội', created_at: monthsAgoDay15(13), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 202, name: 'Tháng 02', email: 'thang02@test.com', phone: '0900000032', address: 'TP HCM', created_at: monthsAgoDay15(12), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 203, name: 'Tháng 03', email: 'thang03@test.com', phone: '0900000033', address: 'Đà Nẵng', created_at: monthsAgoDay15(11), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 204, name: 'Tháng 04', email: 'thang04@test.com', phone: '0900000034', address: 'Cần Thơ', created_at: monthsAgoDay15(10), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 205, name: 'Tháng 05', email: 'thang05@test.com', phone: '0900000035', address: 'Hải Phòng', created_at: monthsAgoDay15(9), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 206, name: 'Tháng 06', email: 'thang06@test.com', phone: '0900000036', address: 'Nha Trang', created_at: monthsAgoDay15(8), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 207, name: 'Tháng 07', email: 'thang07@test.com', phone: '0900000037', address: 'Huế', created_at: monthsAgoDay15(7), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 208, name: 'Tháng 08', email: 'thang08@test.com', phone: '0900000038', address: 'Hà Nội', created_at: monthsAgoDay15(6), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 209, name: 'Tháng 09', email: 'thang09@test.com', phone: '0900000039', address: 'TP HCM', created_at: monthsAgoDay15(5), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 210, name: 'Tháng 10', email: 'thang10@test.com', phone: '0900000040', address: 'Đà Nẵng', created_at: monthsAgoDay15(4), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 211, name: 'Tháng 11', email: 'thang11@test.com', phone: '0900000049', address: 'Cần Thơ', created_at: monthsAgoDay15(3), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 212, name: 'Tháng 12', email: 'thang12@test.com', phone: '0900000050', address: 'Hải Phòng', created_at: monthsAgoDay15(2), status: OrderStatus.Delivered, payment_status: 'Paid' as any }
  ];

  for (const o of ordersData) {
    await prisma.order.create({
      data: { id: o.id, name: o.name, email: o.email, phone: o.phone, address: o.address, total_price: 0, status: o.status, payment_status: (o as any).payment_status ?? 'Unpaid', created_at: o.created_at, delivered_at: DELIVERED_AT_STATUSES.includes(o.status) ? o.created_at : null },
    });
  }
  console.log('✔ Orders');
  ...
  const orderItemsData = [
    ...
    { order_id: 109, product_id: 25, quantity: 3, price: 200000 },
    { order_id: 110, product_id: 9, quantity: 4, price: 150000 },
    { order_id: 111, product_id: 5, quantity: 1, price: 320000 },
    { order_id: 112, product_id: 33, quantity: 2, price: 250000 },
    ...
    { order_id: 121, product_id: 1, quantity: 2, price: 150000 },
    ...
    { order_id: 201, product_id: 1, quantity: 10, price: 150000 },
    { order_id: 202, product_id: 5, quantity: 4, price: 320000 },
    { order_id: 203, product_id: 1, quantity: 11, price: 150000 },
    { order_id: 204, product_id: 25, quantity: 9, price: 200000 },
    { order_id: 205, product_id: 33, quantity: 10, price: 250000 },
    { order_id: 206, product_id: 33, quantity: 7, price: 250000 },
    { order_id: 207, product_id: 25, quantity: 10, price: 200000 },
    { order_id: 208, product_id: 5, quantity: 6, price: 320000 },
    { order_id: 209, product_id: 1, quantity: 12, price: 150000 },
    { order_id: 210, product_id: 9, quantity: 13, price: 150000 },
    { order_id: 211, product_id: 9, quantity: 18, price: 150000 },
  ...
  await prisma.returnRequest.createMany({
    data: [
      { order_id: 101, reason_code: 'Damaged', status: ReturnStatus.Pending },
      { order_id: 102, reason_code: 'Wrong item', status: ReturnStatus.Pending },
      { order_id: 103, reason_code: 'Change mind', status: ReturnStatus.Pending },
      { order_id: 104, reason_code: 'Not as described', status: ReturnStatus.Pending },
      { order_id: 105, reason_code: 'Damaged', status: ReturnStatus.Approved },
      { order_id: 106, reason_code: 'Wrong item', status: ReturnStatus.Approved },
      { order_id: 107, reason_code: 'Change mind', status: ReturnStatus.Approved },
      { order_id: 108, reason_code: 'Change mind', status: ReturnStatus.Approved },
      { order_id: 109, reason_code: 'Damaged', status: ReturnStatus.Rejected },
      { order_id: 110, reason_code: 'Change mind', status: ReturnStatus.Rejected },
      { order_id: 111, reason_code: 'Not as described', status: ReturnStatus.Rejected },
      { order_id: 112, reason_code: 'Not as described', status: ReturnStatus.Pending },
    ],
  });
