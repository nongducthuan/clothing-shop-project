...
async function main() {
  ...
  // ============================================================
  const ordersData = [
    { id: 201, name: 'Nguyễn Văn A', email: 'a@test.com',   phone: '0901', address: 'Hà Nội',    created_at: daysAgo(7), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 202, name: 'Trần Thị B',   email: 'b@test.com',   phone: '0902', address: 'TP HCM',    created_at: daysAgo(6), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 203, name: 'Lê Văn C',     email: 'c@test.com',   phone: '0903', address: 'Đà Nẵng',   created_at: daysAgo(5), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 204, name: 'Phạm Thị D',   email: 'd@test.com',   phone: '0904', address: 'Cần Thơ',   created_at: daysAgo(4), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 205, name: 'Hoàng Văn E',  email: 'e@test.com',   phone: '0905', address: 'Hải Phòng', created_at: daysAgo(3), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 206, name: 'Vũ Thị F',     email: 'f@test.com',   phone: '0906', address: 'Nha Trang', created_at: daysAgo(2), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 207, name: 'Đặng Văn G',   email: 'g@test.com',   phone: '0907', address: 'Huế',       created_at: daysAgo(1), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    // 12 don lap day 30 ngay (8-29 ngay truoc) de monthly != weekly
    { id: 208, name: 'Khách H', email: 'h@test.com', phone: '0908', address: 'Hà Nội', created_at: daysAgo(8), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 209, name: 'Khách I', email: 'i@test.com', phone: '0909', address: 'TP HCM', created_at: daysAgo(10), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 210, name: 'Khách J', email: 'j@test.com', phone: '0910', address: 'Đà Nẵng', created_at: daysAgo(13), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 211, name: 'Khách K', email: 'k@test.com', phone: '0911', address: 'Cần Thơ', created_at: daysAgo(15), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 212, name: 'Khách L', email: 'l@test.com', phone: '0912', address: 'Hải Phòng', created_at: daysAgo(17), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 213, name: 'Khách M', email: 'm@test.com', phone: '0913', address: 'Nha Trang', created_at: daysAgo(20), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 214, name: 'Khách N', email: 'n@test.com', phone: '0914', address: 'Huế', created_at: daysAgo(22), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 215, name: 'Khách O', email: 'o@test.com', phone: '0915', address: 'Hà Nội', created_at: daysAgo(24), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 216, name: 'Khách P', email: 'p@test.com', phone: '0916', address: 'TP HCM', created_at: daysAgo(25), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 217, name: 'Khách Q', email: 'q@test.com', phone: '0917', address: 'Đà Nẵng', created_at: daysAgo(27), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 218, name: 'Khách R', email: 'r@test.com', phone: '0918', address: 'Cần Thơ', created_at: daysAgo(28), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
    { id: 219, name: 'Khách S', email: 's@test.com', phone: '0919', address: 'Hải Phòng', created_at: daysAgo(29), status: OrderStatus.Delivered, payment_status: 'Paid' as any },
  ...
  for (const o of ordersData) {
    await prisma.order.create({
      data: { id: o.id, name: o.name, email: o.email, phone: o.phone, address: o.address, total_price: 0, status: o.status, payment_status: (o as any).payment_status ?? 'Unpaid', created_at: o.created_at, delivered_at: o.created_at },
    });
  }
  console.log('✔ Orders');
  ...
  const orderItemsData = [
    ...
    { order_id: 202, product_id: 5,  quantity: 2,  price: 320000 },
    { order_id: 203, product_id: 9,  quantity: 3,  price: 150000 },
    { order_id: 204, product_id: 33, quantity: 2,  price: 250000 },
    { order_id: 205, product_id: 25, quantity: 3,  price: 200000 },
    { order_id: 206, product_id: 1,  quantity: 4,  price: 150000 },
    { order_id: 207, product_id: 9,  quantity: 3,  price: 150000 },
    // 12 don lap day 30 ngay (8-29 ngay truoc): moi don 300k-800k
    { order_id: 208, product_id: 1,  quantity: 3,  price: 150000 },
    { order_id: 209, product_id: 25, quantity: 2,  price: 200000 },
    { order_id: 210, product_id: 9,  quantity: 4,  price: 150000 },
    { order_id: 211, product_id: 5,  quantity: 2,  price: 320000 },
    { order_id: 212, product_id: 33, quantity: 3,  price: 250000 },
    { order_id: 213, product_id: 1,  quantity: 5,  price: 150000 },
    { order_id: 214, product_id: 25, quantity: 2,  price: 200000 },
    { order_id: 215, product_id: 9,  quantity: 2,  price: 150000 },
    { order_id: 216, product_id: 33, quantity: 2,  price: 250000 },
    ...
    { order_id: 304, product_id: 25, quantity: 8,  price: 200000 },
    { order_id: 305, product_id: 33, quantity: 10, price: 250000 },
    { order_id: 306, product_id: 33, quantity: 10, price: 250000 },
    { order_id: 307, product_id: 25, quantity: 12, price: 200000 },
    { order_id: 308, product_id: 5,  quantity: 8,  price: 320000 },
