...
async function main() {
  ...
  const ordersData = [
    ...
    { id: 112, name: 'Ngày 12', email: 'ngay12@test.com', phone: '0900000012', address: 'Hải Phòng', created_at: daysAgo(19), status: OrderStatus.Return_Rejected, payment_status: 'Paid' as any },
  ...
  await prisma.returnRequest.createMany({
    data: [
      ...
      { order_id: 108, reason_code: 'Not as described', status: ReturnStatus.Approved },
      { order_id: 109, reason_code: 'Damaged', status: ReturnStatus.Rejected },
      { order_id: 110, reason_code: 'Wrong item', status: ReturnStatus.Rejected },
      { order_id: 111, reason_code: 'Change mind', status: ReturnStatus.Rejected },
      { order_id: 112, reason_code: 'Not as described', status: ReturnStatus.Rejected },
    ],
  });
